...
namespace Unity.MobaRPG.Navigation
{
    public sealed class DynamicNavPath : IDisposable
    {
        ...
        /// This gets stored to make sure the path gets recalculated if the target
        /// </summary>
        ...
        /// <summary>
        /// A moving transform target, the path will readhust when the target moves. If this is a non-null, it takes precedence over m_PositionTarget.
        /// </summary>
        ...
        {
            // if there is a nav mesh area close to the target use a point inside the nav mesh instead.
