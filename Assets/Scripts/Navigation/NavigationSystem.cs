...
namespace Unity.MobaRPG.Navigation
{
    ...
    /// The Unity NavMesh is only used to calculate navigathon paths. Moving along those paths is done by this system.
    /// </summary>
    public class NavigationSystem : MonoBehaviour
    {
        ...
        {
            // This is dont in fixed update to make sure that only one expensive global recalculation happens per fixed update.
            if (m_NavMeshChanged)
            {
