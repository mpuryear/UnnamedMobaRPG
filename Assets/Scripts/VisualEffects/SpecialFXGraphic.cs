...
{
    /// <summary>
    /// Utility script attached to special-effects prefabs. These prefabs
    /// are used by various ActionFX that need to show special short-lived graphics
    ...
    /// and then self-destructs after the particles are all gone. PartileSystems can technically
