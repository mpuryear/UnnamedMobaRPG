...
namespace Unity.MobaRPG.Gameplay.Actions
{
    public static class ActionUtils
    {
        ...
        /// <summary>
        /// When doing line-of-sight checks we assume the characteers' "eyes" are at this height above their transform
        /// </summary>
        static readonly Vector3 k_CharacterEyelineOffset = new Vector3(0,0,0);
        ...
        /// </summary>
        /// <param name="character1Pos"></param>
        /// <param name="character2Pos"></param>
        /// <param name="missPos">The point where an obstruction occurred (of if no obstruction, this is just character2Pos)</param>
        /// <returns>True if no obstruction, false if there is a Ground-layer object in the way</returns>
        public static bool HasLineOfSight(Vector3 character1Pos, Vector3 character2Pos, out Vector3 missPos)
        {
            ...
            {
                // Our line of side was obstructed
        ...
        /// - can make sure that the chosen spot is no further than a specific distance away. 
        /// </summary>
        /// <param name="characterTransform">characters transform</param>
        /// <param name="targetSpot">location we want to be next to</param>
        /// <param name="stopAtObstruction">true if we should be blocked by obstructions such as walls</param>
        ...
        public static Vector3 GetDashDestination(Transform characterTransform, Vector3 targetSpot, bool stopAtObstruction, float distanceToUseIfVeryClose = -1, float maxDistance = -1)
        {
            ...
            if (stopAtObstruction)
            {
                // if we're going to hit an obstruction, stop at obstruction
