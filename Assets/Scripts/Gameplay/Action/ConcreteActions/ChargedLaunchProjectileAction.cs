...
namespace Unity.MobaRPG.Gameplay.Actions
{
    ...
    /// 
    /// </remarks>
    [CreateAssetMenu(menuName = "MobaRPG/Actions/Charged Launch Projectile Action")]
    public partial class ChargedLaunchProjectileAction : LaunchProjectileAction
    {
        ...
        public override bool OnStart(ServerCharacter serverCharacter)
        {
            ...
            else if (m_Data.Position != Vector3.zero)
            {
                // If the users cursor is in the world we will be passed a non .zero vector3 to represent it.
                serverCharacter.physicsWrapper.Transform.LookAt(m_Data.Position);
            }
            ...
            Debug.Assert(Config.Projectiles.Length > 1, $"Action {name} has {Config.Projectiles.Length} Projectiles. Expected atleast 2!");
        ...
        /// <summary>
        /// Overridden from base-class to choose a different projectil depending on how "charged up" we got.
