...
namespace Unity.MobaRPG.Gameplay.Actions
{
    ...
    /// 
    /// Since the "Range" field means "range we can teleport to our target", we need another
    /// field to mean "range of our meele attack after dashing". We'll use the "Radius" field of the
    ...
    /// </remarks>
    [CreateAssetMenu(menuName = "MobaRPG/Actions/Dash Attack Action")]
    public class DashAttackAction : Action
    {
        ...
        public override bool OnStart(ServerCharacter serverCharacter)
        {
            ...
            // snap to face our destination. this ensure the client visualization faces the right way while "pretending" to dash
        ...
        public override void Cancel(ServerCharacter serverCharacter)
        {
            ...
            // we need to explicity end the client-side visuals when we abort
