...
namespace Unity.MobaRPG.Gameplay.Actions
{
    ...
    {
        /// <summary>
        /// The "charging up" graphics. These are disabled as soon as the player staops charging up
        /// </summary>
        ...
        public override void AnticipateActionClient(ClientCharacter clientCharacter)
        {
            ...
            // for serveral copies of this action to be playing at once. This can lead to situations where several
