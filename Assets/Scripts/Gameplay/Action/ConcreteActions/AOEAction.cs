...
namespace Unity.MobaRPG.Gameplay.Actions
{
    ...
    /// </summary>
    [CreateAssetMenu(menuName = "MobaRPG/Actions/AOE Action")]
    public class AOEAction : Action
    {
        /// <summary>
        /// Cheat prevention: to ensure that players don't perform AOE outside of their attack range,
        ...
        protected virtual void PerformAoE(ServerCharacter parent)
        {
            // Note: could have a non alloc version of this overlap spehere where we statically store our collider array, but since this is a self
