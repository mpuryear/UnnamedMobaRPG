...
namespace Unity.MobaRPG.Gameplay.Actions
{
    ...
    /// </summary>
    [CreateAssetMenu(menuName = "MobaRPG/Actions/Pick Up Action")]
    public class PickUpAction : Action
    {
        ...
        bool TryPickUp(ServerCharacter parent)
        {
            ...
            // try to set the heavy object follow the hand bone transform, through PositionContraints component
