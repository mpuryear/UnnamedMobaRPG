...
namespace Unity.MobaRPG.Gameplay.Actions
{
    public partial class ChargedLaunchProjectileAction
    {
        ...
        /// </summary>
        /// <remarks>
        /// Permance note: repeatedly creating and destroying GameObjects is not optimal, and on low-resource platforms
        /// (like mobile devices), it can lead to major perfomance problems. On mobile platforms, visual graphics should
        /// use object-pooling (i.e. reusing the same GameObjects repeatedly). But thats outside the scope of this demo.
        /// </remarks>
