...
namespace Unity.MobaRPG.Gameplay.Actions
{
    public partial class TrampleAction
    {
        ...
        /// character, so the graphics are oriented tin the right direction!)
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// Mobile perfomance note: constantly creating new GameObjects like this has bad performance on mobile and should be 
        /// replaced with object-pooling (i.e. reusing the same art GameObjects repeatedly). But thats outside the scope of this demo.
        /// </remarks>
