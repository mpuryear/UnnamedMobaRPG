...
namespace Unity.MobaRPG.Gameplay.Actions
{
    ...
    /// </summary>
    [CreateAssetMenu(menuName = "MobaRPG/Actions/FX Projectile Targeted Action")]
    public partial class FXProjectileTargetedAction : Action
    {
        ...
        public override bool OnStart(ServerCharacter serverCharacter)
        {
            ...
            // figure out how long the pretend-project will be flying to the target
        ...
        private IDamageable GetDamageableTarget(ServerCharacter parent)
        {
            ...
            {
                // target could have legitimately disappeared in the time it took to queue this action... but that's pretty unlikely so we'll about it to ease debugging.
