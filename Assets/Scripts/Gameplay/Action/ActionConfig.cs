...
namespace Unity.MobaRPG.Gameplay.Actions
{
    ...
    public class ActionConfig
    {
        ...
        [Tooltip("Is this Action interruptible by other action-plays or by movement? (Implicitly stops movemnt when actions starts.) Generally, actions with short exec times should not be interruptible in this way.")]
