...
{
    /// <summary>
    /// This is a compaion class to ClientCharacter that is specifically responsible for visualizing Actions. Action visualizations have lifetimes
    ...
    public sealed class ClientActionPlayer
    {
        ...
        /// is detected on the local client. The purpose of this is to help mask latency. Because this demo is server authoritative, the default behaviour is
        ...
        /// To combat this, you can play visual effects immediately. For exmaple, MeleeActionFX plays both its weapon swing and applies a hit react to the target,
        ...
        /// action animation if you are already animating in some way, as one example. Another complexity is that you don't know if they server will actually
        ...
        /// Characters belonging to the server and other characters anyways). It also means we need to handle the case where we created an Anticipated Action, but
        ...
        /// anticipateively, but it could be revised to create and drive the mage bolt effect as well--leaving only damage to arrive in true server time.
        ///
        /// How to implement your own Anticipation logic:
        ///   1. Isoloate the visual feedback you want to play anticipatively in a private helper method on your ActionFX, like "PlayAttackAnim".
