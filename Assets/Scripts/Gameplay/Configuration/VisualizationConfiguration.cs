...
namespace Unity.MobaRPG.Gameplay.Configuration
{
    ...
    public class VisualizationConfiguration : ScriptableObject
    {
        ...
        [Tooltip("Trigger for when a player-character using this visualization becomes incapacitate")]
        ...
        [Tooltip("That animator speed value when the character is standing idle")]
        public float SpeedIdle = 0;
        [Tooltip("The animator Speed value when the character is moving normally")]
        public float SpeedNormal = 1;
        [Tooltip("The animator speed value when the character is being pushed or knocked back")]
        ...
        [Tooltip("The animator speed value when the character is magically hasted")]
        public float SpeedHasted = 1.5f;
        [Tooltip("The animator speed value when the character is moving at a slower walking pace")]
