...
namespace Unity.MobaRPG.Gameplay.UI
{
    ...
    /// Party HUD shows hero portrail and class info for all ally characters
    /// Party HUD also shows healthbars for each player and allows clicks to select an ally
    /// </summary>
    public class PartyHUD : MonoBehaviour
    {
        ...
        void SetTargetName(ulong targetId)
        {
