...
using SkillTriggerStyle = Unity.MobaRPG.Gameplay.UserInput.ClientInputSender.SkillTriggerStyle;
...
namespace Unity.MobaRPG.Gameplay.UI
{
    ...
    public class HeroActionBar : MonoBehaviour
    {
        ...
        /// <summary>
        /// Cahce the input sender from a <see cref="ClientPlayerAvatar"/> and self-initialize.
        /// </summary>
        ...
        void Action1ModifiedCallback()
        {
            ...
            UpdateActionButton(
                m_ButtonInfo[ActionButtonType.BasicAction],
                action,
