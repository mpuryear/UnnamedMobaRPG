...
namespace Unity.MobaRPG.Gameplay.UI
{
    ...
    public class UITooltipPopup : MonoBehaviour
    {
        ...
        /// <summary>
        /// Shows a tooltip at the given coordinates.
        /// </summary>
        ...
        {
            if (gameObject.scene.rootCount > 1) // Hacky way for cheecking if this is a scene object or a prefab instance and not a prefab definition
            {
                if (!m_Canvas)
                {
