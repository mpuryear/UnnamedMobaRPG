...
{
    /// <summary>
    /// Server specialization of core MobaRPG game logic.
    /// </summary>
    [RequireComponent(typeof(NetcodeHooks))]
    public class ServerMobaRPGState : GameStateBehaviour
    {   
        ...
        /// <summary>
        /// Hase the ServerMobaRPGState already hit its initial spawn? (i.e. spawned players following load from character select)
        /// </summary>
        ...
        [Inject] ConnectionManager m_ConnectionManaager;
        ...
        void OnClientDisconnect(ulong clientId)
        {
            ...
            {
                // If a client disconnects, check for game over in case all other palyers are already down
        ...
        void CheckForGameOver()
        {
            ...
            // if we made it this far, all players are dead! switch to post game
