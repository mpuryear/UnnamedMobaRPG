...
namespace Unity.MobaRPG.Gameplay.GameState
{
    ...
    public class NetworkCharSelection : NetworkBehaviour
    {
        ...
        public struct LobbyPlayerState : INetworkSerializable, IEquatable<LobbyPlayerState>
        {
            ...
            private FixedPlayerName m_PlayerName; // I'm sad theres' no 256Bytes fixed list :(

            public int PlayerNumber; // This player's assigned P# (0=P1, 1=P2, ...)
            public int SeatIdx; // Latest seat they were in. -1 means none.
        ...
        /// <summary>
        /// When this becomes true, the lobby is closed and in process of termination (switching to gameplay).
        /// </summary>
        ...
        /// <summary>
        /// RPC to notify the server that a client has chosen a new seat
        /// </summary>
