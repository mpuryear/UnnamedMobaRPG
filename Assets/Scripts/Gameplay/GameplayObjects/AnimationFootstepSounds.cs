...
namespace Unity.MobaRPG.Gameplay.GameplayObjects.AnimationCallbacks
{
    ...
    /// approach, but it does have a flaw: it becomes inaccurate when the charater's speed is slowed.
    /// e.g. if a slowness debuff makes you move at 75% speed, the footsteps will be slightly off because 
    /// we only have sound-loops for 50% and 100%. That's not a big deal in this particular game, thought.
    /// In the rare situations where animated speed is father than 100% (due to speed buffs etc.), we
