...
{
    /// <summary>
    /// MonoBehaviour containing only one NetworkVaraibleInt which represents this object's health.
    /// </summary>
    public class NetworkHealthState : NetworkBehaviour
    {
        ...
        // public subsribably event to be invoked when HP has been replenished
