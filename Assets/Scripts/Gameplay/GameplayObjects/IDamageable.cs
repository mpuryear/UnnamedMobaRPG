...
{
    /// <summary>
    /// Generic interface for damageable object in the game. This includes ServerCharacter, as well as other things like
    ...
    public interface IDamageable
    {
        ...
        public enum SpecialDamageFlags
        {
            ...
            // The "UnusedFlag" flag does nothing. It exists to work around a Unity editor quick involving [Flags] enum:
