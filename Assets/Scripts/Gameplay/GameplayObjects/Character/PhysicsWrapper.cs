...
{
    /// <summary>
    /// Wrapper class for direct references to components relevent to physics.
    /// Each instance of a PhysicsWrapper is registered to a static dictionary, indexed by the NetworkObject's ID.
    /// </summary>
    /// <remarks>
    /// The root GameObject of a PCs & NPCs is not the object which will move through the world, so other classes will
