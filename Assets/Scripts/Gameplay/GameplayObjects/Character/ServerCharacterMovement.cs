...
using Unity.MobaRPG.Navigation;
using Unity.Netcode;
using UnityEngine;
...
namespace Unity.MobaRPG.Gameplay.GameplayObjects.Character
{
    ...
    /// </summary>
    /*[RequiredComponent(typeof(NetworkCharacterState), typeof(NavMeshAgent), typeof(ServerCharacter)), RequireComponent(typeof(Rigidbody))]*/
    ...
    void Awake()
    {
        // disable this NetworkBehaviour until its spawned
        enabled = false;
    }
    ...
    public override void OnNetworkSpawn()
    {
        ...
        /// This does not notify the client that the movement occured due to teleportation, so that needs to
        /// happen in some other way, such as with the custom action visualization in DashTtackActionFX. (Without
