...
namespace Unity.MobaRPG.Gameplay.GameplayObjects.Character.AI
{
    ...
    public class AIBrain
    {
        ...
        private float m_BrainShutoffRange 
        { 
            get { return 3 * m_DetectRangeOverride; } 
        }
        ...
        public AIBrain(ServerCharacter me, ServerActionPlayer myServerActionPlayer)
        {
            ...
            m_Logics = new Dictionary<AIStateType, AIState>
            {
                ...
                [AIStateType.WANDER] = new WanderAIState(this, m_ServerCharacter.physicsWrapper.Transform.position, m_ServerCharacter.Movement),
        ...
        /// <summary>
        /// Should be caleld by the AIBrain's owner each Update()
        /// </summary>
        public void Update()
        {
        ...
        /// </summary>
        /// <param name="inflicter">The person that hurt or healed us, may be null.</param>
        /// <param name="amount">The amount of HP Received, nagative is damage.</param>
        ...
        {
            // First we clean the list -- remove enemies that have disappeared (became null), are dead, etc.
        ...
        /// <summary>
        /// The range at which this character should stop doing anything.
        /// </summary>
        /// <value></value>
        public float BrainShutoffRange
        {
            get
            {
                return m_BrainShutoffRange;
            }
        }
    }
}
