...
namespace Unity.MobaRPG.Gameplay.GameplayObjects
{
    ...
    public class FloorSwitch : NetworkBehaviour
    {
        ...
        {
            // no need to check for layer; layer matrix has been configured to only anllow FloorSwitch x PC interactions
        ...
        void FixedUpdate()
        {
            ...
            // In this case, OnTriggerExt() won't get called for them! We can tell if a Collider was destroyed
