...
namespace Unity.MobaRPG.Gameplay.GameplayObjects
{
    public class GameDataSource : MonoBehaviour
    {
        ...
        // Actions that are directly listed here will get automatically assingned ActionIDs and they don't ened to be a part of m_ActionPrototypes array
        ...
        [Tooltip("All Action prototype scriptable object should be slotted in here")]
        [SerializeField]
