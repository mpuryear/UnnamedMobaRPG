...
namespace Unity.MobaRPG.Gameplay.GameplayObjects
{
    ...
    /// <summary>
    /// NetworkBehavior that represents a player connection and is the "Default Player Prefab" inside Netcode for
    ...
    public class PersistentPlayer : NetworkBehaviour
    {
        ...
        public override void OnNetworkSpawn()
        {
            ...
            // that OwnerClientId could be its default value of (0).
