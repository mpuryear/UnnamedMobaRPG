...
namespace Unity.MobaRPG.ConnectionManagement 
{
    public enum ConnectStatus
    {
        ...
        LoggedInAgain,              // logged in on a separate client, causing this one to be disconnected
        UserRequestedDisconnect,    // Intentional disconnect triggered by the user
        GenericDisconnect,          // Server disconnected, no specific reason given
        Reconnecting,               // client lost connection and is attempting to reconnect
        IncompatibleBuildType,      // client build type is incompatible with this server
    ...
    /// NetworkManager callbacks and other outside calls and redirecting them to the current ConnectionState object.
    /// </summary>
