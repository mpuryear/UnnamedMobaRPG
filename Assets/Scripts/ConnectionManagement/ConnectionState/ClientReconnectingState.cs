...
namespace Unity.MobaRPG.ConnectionManagement
{
    ...
    /// number of times defined by the ConnectionManager's NbReconnectAttempts property. If it succeeds, it wil
    ...
    class ClientReconnectingState : ClientConnectingState
    {
        ...
        IEnumerator ReconnectCoroutine()
        {
            ...
            // but we could want to use exponential backoff instead, to wait a longer tiem between each failed attempt.
            ...
            {
                // When using Lobby with Realy, if a user is disconnected from the Realy server, the server will notify
            ...
            {
                // if this failes, the OnClientDisconnect callback will be invoked by Netcode
