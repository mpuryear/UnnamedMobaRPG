...
namespace Unity.MobaRPG.ConnectionManagement
{
    ...
    public class SessionManager<T> where T : struct, ISessionPlayerData
    {
        ...
        /// <summary>
        /// Adds a connecting player's session data if it is a new connection, or updates their session data in a case of reconnection.
        /// </summary>
        ...
        public void SetupConnectingPlayerSessionData(ulong clientId, string playerId, T sessionPlayerData)
        {
            ...
            if (m_ClientData.ContainsKey(playerId))
            {
                ...
                {
                    // If this connecting client has same player Id as a disconnected client, this is a reconnection.
                    isReconnecting = true;
                }
            }
