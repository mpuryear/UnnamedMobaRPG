...
namespace Unity.MobaRPG.UnityServices.Lobbies
{
    ...
    public sealed class LocalLobby
    {
        ...
        {
            var info = new LobbyData(); // Technically this is largely redundant after the first assignment, but it wont cause any harm to reassign
            ...
            foreach (var player in lobby.Players)
            {
                ...
                // If the player isnt connected to Relay, get the most recent data that the lobby knows.
                // (if we havent seen this player yet, a new local representation of the player will have already been added by the LocalLobby.)
