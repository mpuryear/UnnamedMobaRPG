...
namespace Unity.MobaRPG.Infrastructure
{
    ...
    /// MobaRPG usess this for projectiles. In theory it should use this for imps too, but we wanted to show vanilla spawning vs pooled spawning.
    ...
    public class NetworkObjectPool : NetworkBehaviour
    {
        ...
        /// <summary>
        /// Registers all object in <see cref="PooledPrefabsList"/> to the cache.
        /// </summary>
